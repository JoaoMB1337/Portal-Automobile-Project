            ...
            <div class="container mx-auto p-4">
                <div class="mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <!-- Seção Viagens -->
                        <div class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm flex items-center justify-center">
                            <div>
                                <h2 class="text-2xl font-semibold mb-4 text-gray-900 text-center">Viagens</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm flex flex-col items-center">
                            <h2 class="text-2xl font-semibold mb-4 text-gray-900 text-center">Veículos</h2>
                            <div class="w-full">
                        ...
                        <!-- Seção Projetos -->
                        <div class="bg-white p-6 rounded-lg shadow-sm lg:col-span-2 flex flex-col items-center">
                            <h2 class="text-2xl font-semibold mb-4 text-gray-900 text-center">Projetos</h2>
                            <div class="w-full">
