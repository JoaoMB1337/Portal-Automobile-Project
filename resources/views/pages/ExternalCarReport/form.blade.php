<form action="{{ route('external.car.report.index') }}" method="POST" class="bg-white p-10 rounded-lg shadow-md max-w-xl mx-auto space-y-6">
    @csrf
    <h1 class="text-3xl text-center text-gray-800 mb-6"> Relatórios de Carros Externos</h1>
