@if($trips->isNotEmpty())
    <div class="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto">
        ...
        <form action="{{ route('project.report.generate') }}" method="GET" class="mt-6">
            ...
            <button type="submit" class="w-full bg-green-600 text-white px-4 py-3 rounded-md shadow-sm hover:bg-green-500 text-sm font-medium">Baixar Relatório em PDF</button>
        </form>
    </div>
@else
