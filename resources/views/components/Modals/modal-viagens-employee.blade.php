        ...
        <div
            ...
            <div class="px-4 py-3 ">
                <a id="maps-button" href="#" target="_blank"
                    class="px-2 py-2 mt-3 ml-10 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm  bg-blue-500 text-base font-medium text-white hover:bg-blue-600 focus:outline-none sm:mt-0 sm:w-auto sm:text-sm">
                    Abrir no Maps
                ...
                <a id="add-cost-button" href="#"
                    class="px-2.5 py-2.5   mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm  bg-gray-500 text-base font-medium text-white hover:bg-gray-600 focus:outline-none sm:mt-0 sm:w-auto sm:text-sm">
                    Adicionar custo
                </a>
                <button type="button"
                    class="px-2.5  py-2.5  mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm  bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:w-auto sm:text-sm"
