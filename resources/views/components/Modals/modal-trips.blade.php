<div id="program-modal" class="fixed inset-0 z-50 hidden overflow-y-auto lg:pl-64">
    <div class="flex items-center justify-center min-h-screen p-4 text-center">
        ...
        <div class="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <button type="button" class="absolute top-0 right-0 p-2 m-2 text-gray-400 hover:text-gray-500" onclick="closeTripModal()">
                ...
                <div class="w-full rounded-xl p-7 custom-card mt-6">
                    <form method="POST" action="{{ route('projects.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div>
                                <button id="criarVeiculoBtn" type="button" class="custom-btn w-full py-2 rounded-md mt-4">
