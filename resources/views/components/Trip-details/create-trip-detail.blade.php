<div class="mt-8">
    <form method="POST" action="{{ route('trip-details.store') }}" enctype="multipart/form-data"
        ...
        <a href="{{ route('home') }}">
            <button type="button"
                class="flex items-center justify-center mb-3 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-gray-600 border rounded-lg gap-x-2 sm:w-auto hover:bg-gray-500">
