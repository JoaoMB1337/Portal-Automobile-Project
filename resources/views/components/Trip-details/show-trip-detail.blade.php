                ...
                <div class="border-t border-gray-200 mt-4">
                    <dl>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">{{ $tripDetail->trip->destination }}
                            </dd>
                        </div>
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Tipo de custo</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">{{ $tripDetail->costType->type_name }}
                            </dd>
                        </div>
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">
                                @if ($tripDetail->file)
                                    <img src="{{ asset('storage/projects/' . $project->id . '/trips/' . $tripDetail->trip_id . '/receipts/' . $tripDetail->file) }}"
                                        alt="Comprovante de Gastos" class="max-w-full h-auto">
                                @else
