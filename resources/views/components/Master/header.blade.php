    ...
    <nav id="sidebar"
        ...
        <div class="custom-container px-4 py-8 border-b border-gray-700 flex items-center">
            <div class="mt-5 h-15 bg-white rounded-full flex-shrink-0 mr-2 logo">
                <img src="{{ asset('images/App-logo.png') }}" alt="Logo"
                    class="w-full h-full object-cover rounded-full logo ">
            </div>
        ...
        <div class="overflow-y-auto flex-1">
            <ul class="py-4">
                ...
                <li class="relative">
                    <a href="#" id="trips-menu"
                        class="block text-white py-2 px-4 hover:bg-gray-700 transition-colors duration-200 relative flex items-center">
                        Viagens
                        <svg class="w-4 h-4 ml-1 arrow-down inline-block" fill="none" stroke="currentColor"
                    ...
                    <ul id="trips-submenu" class="bg-gray-600 text-white w-full mt-1 hidden">
                        <li>
                            <a href="/trips"
                                class="block text-white py-2 px-4 hover:bg-gray-700 transition-colors duration-200 ">Ver
                                viagem</a>
                        </li>
                        <li>
                            <a href="/projects"
                ...
                @if (Auth::check() && Auth::user()->isMaster())
                    <li class="relative">
                        ...
                        <ul id="reports-submenu" class="bg-gray-600 text-white w-full mt-1 hidden">
                            <li>
                                <a href="/cost-report"
                                    class="block text-white py-2 px-4 hover:bg-gray-700 transition-colors duration-200">Relatórios
                                    viagens</a>
                            </li>
                            <li>
                                <a href="/external-car-report"
                                    class="block text-white py-2 px-4 hover:bg-gray-700 transition-colors duration-200">Relatórios
                                    veículos</a>
                            </li>
                            <li>
            ...
            @else
                <div class="relative px-4 py-3 border-t border-gray-700">
                    ...
                    <div id="user-dropdown"
                        class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg hidden bottom-12">
                        <div class="py-1">
                            <a href="{{ route('logout') }}"
