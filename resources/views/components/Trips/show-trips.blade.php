<div class="container mx-auto px-4 py-8">
    <a href="{{ url('trips') }}" class="text-indigo-600 hover:text-indigo-900 flex items-center mb-4" title="Voltar para trás">
        ...
        <div class="border-t border-gray-200">
            <dl>
                ...
                <div class="bg-white px-6 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ number_format($totalCost, 2, ',', '.') }}</dd>
                </div>
            </dl>
        </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mt-8">
        <div class="px-6 py-4">
                ...
                <div class="flex justify-between items-center mt-4"> <!-- Adicionado um div para manter o botão na mesma linha -->
                    <a href="{{ route('trip-details.create', ['trip_id' => $trip->id]) }}" class="flex items-center px-4 py-2 bg-green-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring ring-green-300 disabled:opacity-25 transition ease-in-out duration-150">
