    ...
    <div class="max-w-lg w-full bg-white rounded-xl shadow-md p-8 custom-card mt-12">
        ...
        <form action="{{ route('trips.update', $trip->id) }}" method="POST" id="trip-form">
            ...
            <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div class="col-span-2">
                    <button type="submit" id="submit-button" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">Atualizar</button>
                </div>
            </div>
        </form>
    </div>
