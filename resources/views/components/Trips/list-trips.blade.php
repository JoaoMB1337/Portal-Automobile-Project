        ...
        <div class="p-4 md:p-6 rounded-lg shadow-md mb-3 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300">
            <div class="flex flex-col md:flex-row items-center justify-between mb-4 md:mb-6">
                <div class="flex items-center space-x-2 md:space-x-4 mb-4 md:mb-0">
                    ...
                    <svg class=" w-6 h-6 text-gray-70"0 version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <td class="table-actions">
                            @if (Auth::check() && Auth::user()->isMaster())
                                ...
                                <form id="delete-form-{{ $trip->id }}" method="post"
                                    action="{{ route('trips.destroy', $trip->id) }}" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            @endif
                ...
                @empty
                    <tr>
                        <td colspan="6"
                            ...
                            <p class="mt-4 text-center">Nenhum registo encontrado</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
