    ...
    <div class="w-full max-w-2xl bg-white rounded-xl p-7 custom-card mt-12">
        <div class="flex items-center justify-between mb-4">
            <a href="{{ route('insurances.index') }}">
                <button type="button" class="flex items-center justify-center w-10 h-10 px-3 py-2 text-sm text-gray-700 transition-colors duration-200 bg-gray-600 border rounded-lg gap-x-2 hover:bg-gray-500">
        ...
        <div class="px-6 py-4 flex flex-col sm:flex-row gap-4">
            <a href="{{ route('insurances.edit', ['insurance' => $insurance->id]) }}" class="inline-block bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out text-center w-full sm:w-auto">
                Editar
            </a>
            <button id="openModalBtn" class="bg-red-800 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out text-center w-full sm:w-auto">
                Eliminar
            </button>
        </div>
    </div>
