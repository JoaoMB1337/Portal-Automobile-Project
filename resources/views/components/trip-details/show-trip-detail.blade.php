    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <a href="{{ route('trip-details.index') }}">
                <button  type="button" class="btn-projects flex items-center justify-center mt-5 ml-5 w-1/2 mb-3 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-gray-600 border rounded-lg gap-x-2 sm:w-auto hover:bg-gray-500">
